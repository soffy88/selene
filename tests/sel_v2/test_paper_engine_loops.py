...
from sel_v2.paper.paper_engine import PAPER_HARD_STOP_PCT, PaperEngine
...
def test_risk_snapshot_no_breach_within_threshold():
    e = PaperEngine()
    pos = [{"strategy": "s", "sub_account": "a", "direction": "LONG", "entry_price": 100.0, "notional_usdt": 1000.0}]
