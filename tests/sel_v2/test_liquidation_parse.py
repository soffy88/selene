...
_MSG = {
    ...
    "data": [
        {"instId": "BTC-USDT-SWAP", "details": [
            {"instId": None, "side": "sell", "sz": "12", "bkPx": "60000.5", "bkLoss": "3.2",
             "ts": "1782862113207"}]},
        {"instId": "O-USDT-SWAP", "details": [
            {"instId": None, "side": "buy", "sz": "446", "bkPx": "0.5157", "bkLoss": "0",
             "ts": "1782862113207"}]},
    ],
}
...
def test_missing_bkpx_defaults_zero():
    msg = {"data": [{"instId": "BTC-USDT-SWAP", "details": [
        {"side": "buy", "sz": "1", "ts": "1782862113207"}]}]}   # no bkPx/bkLoss
