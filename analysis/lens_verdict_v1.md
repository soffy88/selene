...
| 假设 | 统计量 | 裸 p | BH q | 判定 |
|---|---|---:|---:|---|
| H-CHAN1[K18] | Welch t=0.15 | 0.4403 | 0.6605 | fail |
| H-CHAN1[K30] | Welch t=-0.80 | 0.7858 | 0.9430 | fail |
| H-CHAN2 | Fisher | 0.0672 | 0.1344 | pass ⚠FDR失守 |
| H-CHAN3a[calm] | Fisher lift | 1.0000 | 1.0000 | fail(改编;Coiling UNTESTABLE) |
| H-CHAN3a[low_sigma] | Fisher lift | 0.0001 | 0.0004 | pass(改编;Coiling UNTESTABLE) |
...
- CHAN-3 overlap 阈值:**p70 = 2.328**(2yr 全样本,in-sample,live 冻结)
- ICT-2 zigzag:1.5×ATR(14)(与 CHAN-3 共享,substate 同参)
- ICT-1 VPIN:V_bucket **自适应**(监控服务启动时按 min(30d, 可用) tick 量自举,= 日均 tick 量/50;本次研究日取值 186,928.4 tick 口径),信号阈值 = 滚动 p95,warmup 100 桶;`history_days` 入 metadata(Month-3 评估剔除 <30d)
