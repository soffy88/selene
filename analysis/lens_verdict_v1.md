...
| H-CHAN3a[calm] | Fisher lift | 1.0000 | 1.0000 | fail(Coiling n=12,判据放宽后首批样本) |
| H-CHAN3a[low_sigma] | Fisher lift | 0.0001 | 0.0005 | pass(Coiling n=12,判据放宽后首批样本) |
| H-CHAN3a[coiling] | Fisher lift | 1.0000 | 1.0000 | fail(Coiling n=12,判据放宽后首批样本) |
