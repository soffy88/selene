...
- overlap_ratio 有值 bar:4403/4435;**p70 = 2.326**(全样本内,live 冻结值)
> 标注含 **Coiling = 10 bar**(2026-07-11 判据放宽后,仅近期特征齐全窗口)——原判据以 lift(Fisher)形式纳入下表,样本极小,谨慎解读:

| 域 | 高 overlap 命中率 | 低 overlap 命中率 | Fisher p |
|---|---:|---:|---:|
| Drifting_Calm | 62.8% | 73.0% | 1.0000 |
| σ_pctile<30 | 43.9% | 38.0% | 0.0001 |
| Coiling(n=10) | 0.0% | 0.3% | 1.0000 |

- **verdict(3a,改编):adapted-pass**

### H-CHAN3b 分歧样本(高 overlap 且 sel 处趋势态)

- X(n=492)前向 6-bar 波动 median=0.00683;同态对照(n=823)=0.00801;Calm 基准=0.00646
- MW 单侧 p(波动)=0.0000;p(|收益|)=0.0122;CI90(X−对照)= [-0.00159, -0.00076]
- **verdict(3b):pass**
