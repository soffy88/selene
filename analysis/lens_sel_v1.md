...
| state | bars | share |
|---|---:|---:|
| Drifting_Calm | 3110 | 70.1% |
| Surging | 1265 | 28.5% |
| Drifting_Charged | 34 | 0.8% |
| Critical | 16 | 0.4% |
| Coiling | 10 | 0.2% |

- degraded bars(特征缺失回退):3616 / 4435 = 81.5%
- 稀有状态:Coiling=10、Cascade=0(降级历史条件不可判)、Release 转移=0
...
- 状态序列:Charged×15 → Coiling×10 → Calm×5
- 最新 bar:2026-07-12 00:00 UTC,state=Drifting_Calm,close=64,154
