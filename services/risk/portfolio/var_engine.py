...
class DrawdownController:
    ...
    @property
    def position_scalar(self):
        return self._level.max_position_pct

    @property
    def is_halted(self):
        return not self._level.new_trades_allowed

    def get_status(self) -> dict:
        return {
            "level": self._level.name,
            "current_dd_pct": round(self._current_dd * 100, 2),
            "max_dd_pct": round(self._max_dd * 100, 2),
