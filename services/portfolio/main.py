...
from shared.events.streams import (
    STREAM_SIGNAL_SCORED, STREAM_SIGNAL_SIZED, STREAM_ORDER_LIFECYCLE,
    STREAM_PORTFOLIO_STATE, encode, decode,
)
from shared.models.signal import ScoredSignal
from shared.models.portfolio import PortfolioState, Position, PositionSide, PositionStatus
...
async def consume_loop():
    ...
    while True:
        ...
        sig_results = await r.xreadgroup(
            CG_PORTFOLIO, "portfolio-signals",
            ...
            for msg_id, fields in messages:
                try:
                    ...
                    if sized.get("position_size", 0) > 0:
                        await r.xadd(STREAM_SIGNAL_SIZED, encode(sized),
...
async def state_publisher():
    ...
    while True:
        ...
        try:
            ...
            await r.xadd(STREAM_PORTFOLIO_STATE, encode(state_dict),
                         maxlen=10000, approximate=True)
