...
VALID_TRANSITIONS = {
    ...
    OrderState.SLIPPAGE_ESTIMATE: {OrderState.ROUTING: "Slippage ok", OrderState.QUEUED: "Re-queue", OrderState.CANCELLED: "Slippage too high"},
    ...
    OrderState.OPEN:              {OrderState.PARTIALLY_FILLED: "Partial", OrderState.FILLED: "Full fill", OrderState.CANCELLED: "Cancelled"},
    OrderState.PARTIALLY_FILLED: {OrderState.FILLED: "Complete", OrderState.CANCELLED: "Partial cancel", OrderState.MONITORING: "Accept partial"},
...
class OrderRecord:
    ...
    @property
    def notional(self):
        return (self.filled_price * self.filled_qty if self.filled_qty
                else self.entry_price * self.quantity)
...
class OrderFSM:
    ...
    def transition(self, new_state: OrderState, note: str = "") -> None:
        ...
        self.record.history.append({
            ...
            "description": allowed[new_state], "note": note,
    ...
    def on_fill(self, qty: float, price: float, fee: float = 0.0) -> None:
        ...
        if self.record.entry_price > 0:
            self.record.slippage_pct = (self.record.filled_price - self.record.entry_price) / self.record.entry_price * 100
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "entry_price": r.entry_price, "filled_price": r.filled_price,
